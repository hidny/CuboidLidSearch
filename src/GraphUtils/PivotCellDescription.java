...
public class PivotCellDescription {
	...
	*/
	...
	public PivotCellDescription(CuboidLidToFoldOn exampleCuboid, int cellNumber, int rotation) {
		...
		for(int i=0; i<NUM_ROTATIONS; i++) {
			...
			while(exampleCuboid.getNeighbours(curCellIndex)[rotToUse] != null
					&& Model.Utils.getSideCell(exampleCuboid, exampleCuboid.getNeighbours(curCellIndex)[rotToUse].getIndex())
...
*/
	...
	public static ArrayList<PivotCellDescription> getUniqueRotationListsWithCellInfo(CuboidLidToFoldOn exampleCuboid) {
	...
	public static void main(String args[]) {
		...
		CuboidLidToFoldOn exampleCuboid = new CuboidLidToFoldOn(7, 1, 1);
