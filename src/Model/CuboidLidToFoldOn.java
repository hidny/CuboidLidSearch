...
public class CuboidLidToFoldOn {
	...
	public CuboidLidToFoldOn(int a, int b, int c) {
	...
	public CuboidLidToFoldOn(CuboidLidToFoldOn orig) {
	...
	public static void main(String args[]) {
		CuboidLidToFoldOn c = new CuboidLidToFoldOn(3, 4, 5);
