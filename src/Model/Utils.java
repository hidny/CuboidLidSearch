...
public class Utils {
	...
	public static int getSideCell(CuboidLidToFoldOn inputCuboid, int cellIndex) {
	...
	//TODO: remove empty border (reuse code)
		...
		public static boolean cuboidDimensionsMatch(CuboidLidToFoldOn cuboid1, CuboidLidToFoldOn cuboid2) {
